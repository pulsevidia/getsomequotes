import { Center, Loader, Title, Text, Group, Image, Blockquote } from "@mantine/core";
...
function ReadBlog() {
  ...
  return <Group miw={300} maw={600} px={'md'} mx={'auto'}>
    <Image w={'100%'} miw={300} maw={600} src={`/images_4_blogs/${randomImage}`} radius={'md'} h={300} />
    <MarkdownToCustom markdown={data.blog_markdown} /></Group>;
}
